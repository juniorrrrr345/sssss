-- Migration pour Al Gran Database
-- Ce script supprime et recrée toutes les tables pour résoudre les problèmes de colonnes manquantes
...
DROP TRIGGER IF EXISTS increment_category_count;
DROP TRIGGER IF EXISTS decrement_category_count;
DROP TRIGGER IF EXISTS update_category_count_on_status_change;
...
CREATE TRIGGER update_category_count_on_status_change
AFTER UPDATE ON products
